...
export default function Posts() {
    const posts = [
      ...
      {nome: "barked", imagem: "./media/barked.svg", foto: "./media/dog.svg", alt: "Doguinho tirando um cochilo no chão", imgPerfilCurtiu: "./media/nathy.png", perfilCurtiu: "nathyohana1", curtidas: "3289"}
